...
public class EmployeeServiceImplTest {
	...
	public void testGetAllEmployees() {
		...
		when(employeeRepoMock.findAll()).thenReturn(mockEmployees);
	...
	public void testUpdateEmployee() {
	    ...
	    assertEquals(employee2, updatedEmployee);
   ...
   public void testUpdateEmployeeNotFound() {
    ...
    public void testDeleteEmployee() {
        when(employeeRepoMock.existsById(1L)).thenReturn(true);
        employeeService.deleteEmployee(1L);
        verify(employeeRepoMock, times(1)).deleteById(1L);
    }

	@Test
	public void testDeleteEmployeeNotFound() {
	        when(employeeRepoMock.existsById(3L)).thenReturn(false);
	        assertThrows(EmployeeNotFoundException.class, () -> {
